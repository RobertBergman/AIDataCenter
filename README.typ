...
#link("docs/training-guide/") is the exception: it is authored directly
in Typst (no Markdown source, own
#link("docs/training-guide/lib.typ")[lib.typ] styling) and is not part
of the `md2pdf.py` set. Build it with:
